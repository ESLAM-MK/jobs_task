            ...
            <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="flex flex-col space-y-6 max-w-xl">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-3 pt-2 ">
                        <Link href={'/jobs'} className="hover:cursor-pointer w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-8 py-3.5 rounded-2xl shadow-md hover:shadow-lg transition-all whitespace-nowrap" >
                ...
                <div ref={imageRef} className="relative w-full aspect-4/3 max-w-2xl justify-self-center lg:justify-self-end">
                    <Image src="/images/home.jpg" alt="Job Platform Illustration" fill priority sizes="(max-w-768px) 100vw, 50vw" className="object-contain shadow-2xl shadow-gray-400" />
                </div>
            </div>
        </section>
    )
